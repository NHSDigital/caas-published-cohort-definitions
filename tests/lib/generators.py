import uuid
from .constants import ERROR_INVALID_VALUE, ERROR_MISSING_VALUE, ERROR_NULL_VALUE, ERROR_DUPLICATE_VALUE, ERROR_ACCESS_DENIED, ERROR_TOO_FEW_ITEMS, ERROR_FORBIDDEN, ERROR_NOT_ACCEPTABLE, ERROR_UNSUPPORTED_MEDIA, ERROR_NO_SUCH_ROUTING_PLAN, ERROR_MISSING_ROUTING_PLAN_TEMPLATE, ERROR_DUPLICATE_ROUTING_PLAN_TEMPLATE, ERROR_NOT_FOUND, ERROR_QUOTA, ERROR_REQUEST_TIMEOUT, ERROR_SERVICE_TIMEOUT, VALID_ROUTING_PLAN_ID_PROD, VALID_ROUTING_PLAN_ID_SANDBOX
